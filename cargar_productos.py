...
def cargar_productos_base():
    ...
    productos_data = [
        ...
        {"nombre": "Yogur Natural", "precio": 320, "marca": "La Serenísima", "codigo_barra": 779123456002, "categoria": "Lácteos"},
...
def ejecutar_carga_completa():
    ...
    try:
        ...
        # 4. Cargar inventario (siempre, para asegurar que todos los productos tengan stock)
        # Esto es importante porque si los productos ya existían, también necesitan inventario
        total_productos = Productos.objects.count()
        if total_productos > 0:
            cargar_inventario_inicial(sucursal)
        else:
            print("⚠️  No hay productos en el sistema, no se puede cargar inventario")
